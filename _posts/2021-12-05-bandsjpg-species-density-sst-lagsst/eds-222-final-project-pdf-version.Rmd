...
```
\begin{itemize}
  \item[] Figure 2. The cumulative effect that SST anomalies have on the three species which have the largest negative slope estimates of all statistically significant results. The effect accumulates from the current year to the following 5 years.  
\end{itemize}
...
```
\begin{itemize}
  \item[] Figure 3. The cumulative effect that SST anomalies have on the three species which have the largest positive slope estimates of all statistically significant results. The effect accumulates from the current year to the following 5 years.  
\end{itemize}
<hr>  
# Future Work  
